...
final class MoveSummarySession {
  ...
  late final _messages = MessagesStream(_transport);

  Usage get _usage => _messages.usage;
  ...
  Stream<SummaryEvent> _stream(
    ...
    required MessageTurn turn,
      ...
      .stream(body, apiKey: apiKey, cancel: cancel, turn: turn)
      .map(SummaryText.new);
}
